  ...
  var require_deviceKey = __commonJS({
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      module.exports = {
        ...
        clearDeviceSession,
        // New exports for device header approach
      ...
      instance.interceptors.response.use((response) => {
        if (response.data) {
          ...
          if (response.data.status === "authenticated") {
            ...
            if (response.data.device_key && response.data.guid && response.data.handle) {
              const { getDeviceHeader: getDeviceHeader2, generateDeviceHeader } = require_deviceKey();
              const existingHeader = getDeviceHeader2();
              if (!existingHeader) {
                generateDeviceHeader(
