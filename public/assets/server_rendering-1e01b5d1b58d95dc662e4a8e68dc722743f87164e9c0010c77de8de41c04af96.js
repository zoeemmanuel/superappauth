(() => {
  ...
  var require_deviceKey = __commonJS({
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      var generateDeviceHeader = (deviceId, userGuid, userHandle) => {
        if (!deviceId || !userGuid) {
          console.warn("Missing required parameters for device header");
          return null;
        }
        try {
          const headerData = {
          ...
          console.log("Generated and stored device header for cross-browser recognition");
          return headerString;
        } catch (err) {
      ...
      var getDeviceHeader2 = () => {
        try {
          ...
          console.log("Found device header in localStorage for cross-browser recognition");
          return headerString;
        } catch (err) {
        ...
        if (response.data) {
          ...
          if (response.data.status === "authenticated") {
            ...
            if (response.data.device_header_data) {
              const { generateDeviceHeader } = require_deviceKey();
              generateDeviceHeader(
