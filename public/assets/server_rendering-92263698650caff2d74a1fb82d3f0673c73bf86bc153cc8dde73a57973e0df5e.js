  ...
  var require_deviceKey = __commonJS({
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      var createInstallationId = () => {
        ...
        const hardwareId = `${screenWidth}_${screenHeight}_${colorDepth}`;
        const randomPart = Math.random().toString(36).substring(2, 8);
        return hardwareId + "_" + randomPart;
      };
      var generateDeviceFingerprint = async () => {
        try {
          ...
          localStorage.setItem("fingerprint_version", "2");
          return deviceFingerprint;
        } catch (err) {
          console.error("Error generating fingerprint:", err);
          try {
            const basicInfo = `${window.screen.width}x${window.screen.height}|${navigator.language}|${navigator.platform}`;
