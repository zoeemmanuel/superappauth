(() => {
  ...
  var require_deviceKey = __commonJS({
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      var getCompleteDeviceHeaderFromStorage = () => {
        try {
          ...
          if (parsedHeader.deviceId && parsedHeader.userGuid && parsedHeader.userHandle) {
            console.log("Found complete device header in localStorage:", {
      ...
      var storeDeviceSessionData2 = (data) => {
        ...
        if (data.device_header_data) {
          ...
          if (!headerStored) {
            ...
            try {
              console.log("Forcing storage of complete device header:", {
                deviceId: headerData.deviceId.substring(0, 10) + "...",
                userGuid: headerData.userGuid,
                userHandle: headerData.userHandle
              });
  ...
  var UnifiedLogin = () => {
    ...
    const checkDevice = async () => {
      ...
      try {
        ...
        if (completeHeader) {
          ...
          console.log("No complete device header found - using device fingerprint for recognition only");
    ...
    const handleHandleSubmit = async () => {
      ...
      try {
        ...
        const requestHeaders = {};
        if (completeHeader) {
          console.log("Using complete device header for handle submission:", {
            deviceId: completeHeader.deviceId.substring(0, 10) + "...",
            userGuid: completeHeader.userGuid,
            userHandle: completeHeader.userHandle
          });
          ...
          console.log("No complete header found - proceeding without cross-browser auth");
        }
        const deviceKey = await (0, import_deviceKey2.getStoredDeviceKey)();
        if (deviceKey) {
          requestHeaders["X-Device-Key"] = deviceKey;
