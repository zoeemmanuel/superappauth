(() => {
  ...
  var UnifiedLogin = () => {
    ...
    const [isDeviceCheckRunning, setIsDeviceCheckRunning] = (0, import_react2.useState)(false);
    const deviceChannelRef = (0, import_react2.useRef)(null);
    ...
    (0, import_react2.useEffect)(() => {
      console.log("UnifiedLogin mounted");
      localStorage.removeItem("loop_detected");
      checkDevice();
      const connectingTimeout = setTimeout(() => {
        if (flowState === "checking") {
          console.log("Connecting timeout - resetting UI");
  ...
  `;
    ...
    const handleHandleSubmit = async () => {
      ...
      try {
        ...
        if (response.data.status === "verification_needed" || response.data.phone || response.data.masked_phone) {
