    ...
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      var generateDeviceHeader2 = (deviceId, userGuid, userHandle) => {
        ...
        try {
          ...
          console.log(
            "Device header creation result:",
            success ? "SUCCESS" : "FAILED",
            "Header:",
            JSON.stringify(headerData).substring(0, 50) + "..."
          );
      ...
      var storeDeviceSessionData = (data) => {
        ...
        if (data.device_header_data) {
          console.log(
            ...
            JSON.stringify(data.device_header_data)
          );
          const headerStored = generateDeviceHeader2(
          ...
          const headerStored = generateDeviceHeader2(data.device_key, data.guid, data.handle);
          console.log("Fallback device header storage result:", headerStored ? "SUCCESS" : "FAILED");
        } else {
          console.warn(
