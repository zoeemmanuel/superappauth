(() => {
  ...
  var require_deviceKey = __commonJS({
    "app/javascript/utils/deviceKey.js"(exports, module) {
      ...
      var getCompleteDeviceHeaderFromStorage2 = () => {
        try {
      ...
      var getStoredDeviceKey3 = async () => {
        try {
          ...
          const completeHeader = getCompleteDeviceHeaderFromStorage2();
      ...
      module.exports = {
        ...
        getCompleteDeviceHeaderFromStorage: getCompleteDeviceHeaderFromStorage2
